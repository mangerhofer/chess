...
public class GameServer {
    ...
    public GameServer run(int port) {
        ...
        Spark.delete("/Game/:game", this::deleteGame);
    ...
    private Object createGame(Request req, Response res) throws DataAccessException {
        ...
        gameData = service.createGame(gameData.gameName());
    ...
    private Object updateGame(Request req, Response res) throws DataAccessException {
        ...
        return new Gson().toJson(service.updateGame(gameData.gameID(),playerColor,username));
//        return new Gson().toJson(gameData);
    }
