...
class GameServiceTest {
    ...
    void updateGame() throws DataAccessException {
        ...
        game1 = service.updateGame(game1.gameID(), "joe", "sally", game1.gameName(), game1.game());
        game2 = service.updateGame(game2.gameID(), "sally", "fred", game2.gameName(), game2.game());
        game2 = service.updateGame(game2.gameID(), "sally", "fred", game2.gameName(), chess);
